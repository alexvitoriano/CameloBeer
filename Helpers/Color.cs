...
namespace CameloBeer.Helpers
{
	public static class AppColors
	{
		...
		public static readonly Color CONTENTLIGHTBKG = Color.FromHex("f3722e");
		//public static readonly Color CONTENTLIGHTBKG = Color.FromHex("49698A");original
		...
		public static readonly Color LABELBLACK = Color.Black;
